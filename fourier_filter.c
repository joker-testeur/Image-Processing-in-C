...
{
    // Prompt the user.
    printf("Quel type de fréquence souhaitez-vous filter ? (1)");
    printf(" frequences basses, (2) frequences hautes.\n");
    int option;
    scanf("%d", &option);
    ...
    switch (option) {
        case 2:
            printf("Transformation de fourier sur des fréquences hautes...\n");
            high = 1;
            break;
        default:
            printf("Transformation de fourier sur des fréquences basses...\n");
            high = 0;
            break;
    }

    // Inform the user.
    printf("Réalisation de la transformation de fourrier 2D de l'image...\n");
