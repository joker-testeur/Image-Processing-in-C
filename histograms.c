...
// Fonction permettant de retourner la valeur maximale d'un tableau d'entiers
...
// Fonction permettant de générer pour une image donnée l'histogramme correspondant
