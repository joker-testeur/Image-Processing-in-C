...
float*** equalize (float*** input, int M_in, int N_in)
{
    ...
    // Prompt the user.
    printf("Choisisser la spécification à appliquer? (1) for");
    printf(" Histogramme augmentant linéairement dans la moitié inférieure, et");
    printf(" Diminuant linéairement dans la moitié supérieure, (2) Histogramme");
    printf(" diminuant dans la moitié inférieure et augmentant dans la moitié supérieure.\n");
    scanf("%d", &option);
